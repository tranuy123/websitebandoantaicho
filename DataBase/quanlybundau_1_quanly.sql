...
CREATE TABLE `quanly` (
  ...
  `TenQL` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  ...
  CONSTRAINT `quanly_ibfk_1` FOREIGN KEY (`UserName`) REFERENCES `account` (`UserName`)
...
INSERT INTO `quanly` VALUES ('QL01','THÁI LAI','2001-05-28 00:00:00',_binary '\0','364956001','215559958','admin');
