...
CREATE TABLE `loaifood` (
  `IDLoaiF` char(10) NOT NULL,
  `TENLoaiF` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`IDLoaiF`)
...
INSERT INTO `loaifood` VALUES ('MONCHINH','Món chính'),('MONPHU','Món phụ'),('NUOC','Nước'),('TRANGMIENG','Tráng miệng');
